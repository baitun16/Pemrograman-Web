...
<div class="row">
  <div class="content">
    <div class="card">
      <h2 style="font-family: sitka small;">PEMIRA HIMASIFO</h2>
      <hr>

    <div class="kotak">
      <div class="img">
        <img src="pemira.jpeg" style="height: 250px;">
      </div>     
      <p style="font-family: constantia; font-size: 24px; text-align: center;"> Pemilu Raya Himasifo ini diselenggarakan setiap tahunnya untuk mendapatkan wakil dari mahasiswa yang benar-benar berpotensi dalam memimpin organisasi mahasiswa, maka sangat dibutuhkan campur tangan dari seluruh komponen khususnya keluarga Himasifo </p>
    </div> 
    </div>   
  </div>
